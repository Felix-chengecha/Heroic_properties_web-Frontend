...
<section id="section4" class="  dark:bg-gray-800 text-gray-900 dark:text-gray-100">
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 ">
        <div class="mb-4">
            <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                ...
                <p class="mx-auto mt-4 max-w-3xl text-xl text-gray-600 dark:text-slate-400">feel free to contact us </p>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-2">
                <div class="h-full pr-6">
                    <p class="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                     Have questions about our property management services? Whether you're a homeowner, tenant, or investor, we're here to help. 
                     Get in touch with us today, 
                     and let's discuss how we can assist you in managing your property effectively and stress-free.
                    </p>
...
<section class="bg-blue-50 dark:bg-slate-800" id="newsletter">
<div class="max-w-screen-xl mx-auto lg:flex lg:items-center p-10  ml-10">
    <div class="lg:w-0 lg:flex-1">
        <h2 id="newsletter-headline"
            class="text-2xl leading-9 tracking-tight text-gray-700 font-semilbold sm:text-4xl sm:leading-10">
        ...
        <form aria-labelledby="newsletter-headline">
            <div class="">
                <div class="sm:flex items-center">
                    <input name="EMAIL" type="email" required="required" placeholder="Enter your email" aria-label="Email address" class="w-full px-5 py-3 text-base leading-6 transition duration-150 ease-in-out border-2 rounded-md appearance-none focus:outline-none sm:max-w-xs border-gray-200 text-gray-900 placeholder-gray-500 focus:placeholder-gray-400 bg-white">
